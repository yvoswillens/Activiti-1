        ...
        if (objectMapper == null) {
            ...
            synchronized (this) {
                if (objectMapper == null) {
                    ...
                    objectMapper.registerSubtypes(HumanStepDefinition.class, FeedbackStepDefinition.class, ParallelStepsDefinition.class,
                            ChoiceStepsDefinition.class, ListStepDefinition.class, ListConditionStepDefinition.class,
