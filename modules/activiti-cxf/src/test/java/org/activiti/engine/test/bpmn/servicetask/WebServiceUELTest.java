...
public class WebServiceUELTest extends AbstractWebServiceTaskTest {
    ...
    public void testWebServiceInvocationWithDataFlowUEL() throws Exception {
        ProcessDefinitionEntity processDefinition = processEngineConfiguration.getCommandExecutor().execute(
        ...
        ProcessInstance instance = processEngine.getRuntimeService().startProcessInstanceByKey("webServiceInvocationWithDataFlowUEL",
                variables);
