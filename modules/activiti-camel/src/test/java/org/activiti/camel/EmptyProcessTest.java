...
public class EmptyProcessTest extends SpringActivitiTestCase {
    ...
    public void setUp() throws Exception {
        camelContext.addRoutes(new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:startEmptyWithHeader").setHeader("MyVar", constant("Foo")).to(
                        "activiti:emptyProcess?copyVariablesFromHeader=true");
    ...
    public void testRunProcessWithHeader() throws Exception {
        ...
        HistoricVariableInstance var = processEngine.getHistoryService().createHistoricVariableInstanceQuery().variableName("camelBody")
                .singleResult();
        assertNotNull(var);
