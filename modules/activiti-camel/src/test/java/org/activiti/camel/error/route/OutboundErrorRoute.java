...
public class OutboundErrorRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        // back
        from("activiti:ErrorHandling:HandleError").routeId("errorWithDlq").errorHandler(deadLetterChannel("seda:dlq"))
                .log(LoggingLevel.INFO, "Provoked error").beanRef("brokenService") // <--
                                                                                   // throws
                                                                                   // Exception
                .to("seda:inbound");
    }
