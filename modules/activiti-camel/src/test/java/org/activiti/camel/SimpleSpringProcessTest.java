...
public class SimpleSpringProcessTest extends SpringActivitiTestCase {
    ...
    public void setUp() throws Exception {
        camelContext.addRoutes(new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("activiti:camelProcess:serviceTask1").setBody().simple("property[var1]").to("mock:service1").setProperty("var2")
                        .constant("var2").setBody().mvel("properties");
            }
        });
    ...
    public void testRunProcessByKey() throws Exception {
        ...
        String instanceId = runtimeService.createProcessInstanceQuery().processInstanceBusinessKey("key1").singleResult()
