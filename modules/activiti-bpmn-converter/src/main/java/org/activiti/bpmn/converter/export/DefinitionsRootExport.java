...
public class DefinitionsRootExport implements BpmnXMLConstants {
    ...
    protected static final Set<String> defaultNamespaces = new HashSet<String>(Arrays.asList(XSI_PREFIX, XSD_PREFIX,
            ACTIVITI_EXTENSIONS_PREFIX, BPMNDI_PREFIX, OMGDC_PREFIX, OMGDI_PREFIX));
