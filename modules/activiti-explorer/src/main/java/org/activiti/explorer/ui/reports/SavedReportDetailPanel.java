...
public class SavedReportDetailPanel extends DetailPanel {
    ...
    public SavedReportDetailPanel(String historicProcessInstance) {
        ...
        this.historicProcessInstance = ProcessEngines.getDefaultProcessEngine().getHistoryService().createHistoricProcessInstanceQuery()
                .processInstanceId(historicProcessInstance).singleResult();
    ...
    protected void initForm() {
        ...
        HistoricVariableInstance historicVariableInstance = ProcessEngines.getDefaultProcessEngine().getHistoryService()
                .createHistoricVariableInstanceQuery().processInstanceId(historicProcessInstance.getId()).variableName("reportData")
                .singleResult();
