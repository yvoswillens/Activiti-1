...
public class TaskMenuBar extends ToolBar {
    ...
    protected void initItems() {
        ...
        ToolbarEntry involvedEntry = addToolbarEntry(ENTRY_INVOLVED, i18nManager.getMessage(Messages.TASK_MENU_INVOLVED),
                new ToolbarCommand() {
                    public void toolBarItemSelected() {
        ...
        ToolbarEntry archivedEntry = addToolbarEntry(ENTRY_ARCHIVED, i18nManager.getMessage(Messages.TASK_MENU_ARCHIVED),
                new ToolbarCommand() {
                    public void toolBarItemSelected() {
