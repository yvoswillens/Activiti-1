        ...
        if (processDefinitionEntity != null) {
            ...
            if (ExplorerApp.get().isUseJavascriptDiagram()) {
                try {
                    ...
                    final InputStream definitionStream = repositoryService.getResourceAsStream(processDefinition.getDeploymentId(),
                    ...
                    if (!bpmnModel.getFlowLocationMap().isEmpty()) {
                        ...
                        URL url = new URL(explorerURL.getProtocol(), explorerURL.getHost(), explorerURL.getPort(), explorerURL.getPath()
                                .replace("/ui", "")
            ...
            if (!didDrawImage && processDefinitionEntity.isGraphicalNotationDefined()) {
                ...
                StreamResource diagram = new ProcessDefinitionImageStreamResourceBuilder().buildStreamResource(processInstance,
                        repositoryService, runtimeService, diagramGenerator, processEngineConfiguration);
