...
public class MainMenuBar extends HorizontalLayout {
    ...
    protected void initButtons() {
        ...
        Button taskButton = addMenuButton(ViewManager.MAIN_NAVIGATION_TASK, i18nManager.getMessage(Messages.MAIN_MENU_TASKS),
        ...
        Button processButton = addMenuButton(ViewManager.MAIN_NAVIGATION_PROCESS, i18nManager.getMessage(Messages.MAIN_MENU_PROCESS),
        ...
        Button reportingButton = addMenuButton(ViewManager.MAIN_NAVIGATION_REPORT, i18nManager.getMessage(Messages.MAIN_MENU_REPORTS),
        ...
        if (ExplorerApp.get().getLoggedInUser().isAdmin()) {
            Button manageButton = addMenuButton(ViewManager.MAIN_NAVIGATION_MANAGE, i18nManager.getMessage(Messages.MAIN_MENU_MANAGEMENT),
                    Images.MAIN_MENU_MANAGE, false, 90);
