    ...
    protected void initActions(final AbstractPage parentPage) {
        ...
        activateButton.addListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ChangeProcessSuspensionStatePopupWindow popupWindow = new ChangeProcessSuspensionStatePopupWindow(
                        processDefinition.getId(), parentPage, false);
        ...
        List<Job> jobs = ProcessEngines.getDefaultProcessEngine().getManagementService().createJobQuery()
