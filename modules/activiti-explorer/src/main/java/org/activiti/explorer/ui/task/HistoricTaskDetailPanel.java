...
public class HistoricTaskDetailPanel extends DetailPanel {
    ...
    protected void initHeader() {
        ...
        // Add due date
        PrettyTimeLabel dueDateLabel = new PrettyTimeLabel(i18nManager.getMessage(Messages.TASK_DUEDATE_SHORT), historicTask.getDueDate(),
        ...
        // Add create date
        PrettyTimeLabel createLabel = new PrettyTimeLabel(i18nManager.getMessage(Messages.TASK_CREATED_SHORT), historicTask.getStartTime(),
                "", true);
    ...
    protected void initParentTaskLink() {
        if (historicTask.getParentTaskId() != null) {
            final HistoricTaskInstance parentTask = historyService.createHistoricTaskInstanceQuery().taskId(historicTask.getParentTaskId())
                    .singleResult();
    ...
    protected void initSubTasks() {
        ...
        List<HistoricTaskInstance> subTasks = historyService.createHistoricTaskInstanceQuery().taskParentTaskId(historicTask.getId())
                .list();
