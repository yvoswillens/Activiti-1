...
public class ReportDetailPanel extends DetailPanel {
    ...
    public ReportDetailPanel(String processDefinitionId, AbstractPage parentPage) {
        ...
        this.processDefinition = ProcessEngines.getDefaultProcessEngine().getRepositoryService().createProcessDefinitionQuery()
    ...
    protected void initForm() {
        ...
        if (startFormData != null
                && ((startFormData.getFormProperties() != null && !startFormData.getFormProperties().isEmpty()) || startFormData
                        .getFormKey() != null)) {
    ...
    protected void generateReport(ProcessInstance processInstance) {
        ...
        HistoricVariableInstance historicVariableInstance = ProcessEngines.getDefaultProcessEngine().getHistoryService()
                .createHistoricVariableInstanceQuery().processInstanceId(processInstance.getId()).variableName("reportData").singleResult();
