...
public class TaskTable extends Table implements TaskFormModelListener {
    ...
    protected Object addTaskRow(Object previousTaskItemId, String taskName, String taskAssignee, String taskGroups, String taskDescription,
            Boolean startWithPrevious) {
        ...
        try {
            for (User user : ProcessEngines.getDefaultProcessEngine().getIdentityService().createUserQuery().orderByUserFirstName().asc()
                    .list()) {
        ...
        try {
            for (Group group : ProcessEngines.getDefaultProcessEngine().getIdentityService().createGroupQuery().orderByGroupName().asc()
                    .list()) {
    ...
    public List<HumanStepDefinition> getSteps() {
        ...
        for (Object itemId : getItemIds()) {
            ...
            humanStepDefinition.setStartsWithPrevious((boolean) ((CheckBox) item.getItemProperty(ID_START_WITH_PREVIOUS).getValue())
                    .booleanValue());
