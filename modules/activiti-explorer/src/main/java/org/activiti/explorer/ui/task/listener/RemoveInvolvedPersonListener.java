...
public class RemoveInvolvedPersonListener implements ClickListener {
    ...
    public void buttonClick(ClickEvent event) {
        ...
        ConfirmationDialogPopupWindow confirmationPopup = new ConfirmationDialogPopupWindow(i18nManager.getMessage(
                Messages.TASK_INVOLVED_REMOVE_CONFIRMATION_TITLE, name), i18nManager.getMessage(
