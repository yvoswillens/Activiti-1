...
public class SimpleTableEditor extends AbstractPage {
    ...
    protected ToolBar initToolbar() {
        ...
        toolBar.addToolbarEntry(KEY_EDITOR, ExplorerApp.get().getI18nManager().getMessage(Messages.PROCESS_EDITOR_TITLE),
                new ToolbarCommand() {
        ...
        toolBar.addToolbarEntry(KEY_PREVIEW, ExplorerApp.get().getI18nManager().getMessage(Messages.PROCESS_EDITOR_BPMN_PREVIEW),
                new ToolbarCommand() {
                    public void toolBarItemSelected() {
    ...
    protected void showDiagram() {
        StreamResource.StreamSource streamSource = new StreamSource() {
            ...
            public InputStream getStream() {
                WorkflowDefinitionConversion workflowDefinitionConversion = ExplorerApp.get().getWorkflowDefinitionConversionFactory()
    ...
    protected void save() {
        ...
        try {
            ...
            repositoryService.addModelEditorSourceExtra(model.getId(), IOUtils.toByteArray(diagramGenerator.generateDiagram(
