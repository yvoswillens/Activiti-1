...
public class ReassignAssigneeListener implements ClickListener {
    ...
    public void buttonClick(ClickEvent event) {
        ...
        final SelectUsersPopupWindow involvePeoplePopupWindow = new SelectUsersPopupWindow(
                i18nManager.getMessage(Messages.TASK_ASSIGNEE_REASSIGN), false, ignoredIds);
            ...
            protected void submitted(SubmitEvent event) {
                ...
                if (selectedUser != null) {
                    ...
                    ProcessEngines.getDefaultProcessEngine().getTaskService()
                            .deleteUserIdentityLink(task.getId(), originAssignee, IdentityLinkType.ASSIGNEE);
                } else {
                    return;
                }
