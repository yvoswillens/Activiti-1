...
public class SuspendedProcessDefinitionListQuery extends AbstractLazyLoadingQuery {
    ...
    public List<Item> loadItems(int start, int count) {
        List<ProcessDefinition> processDefinitions = repositoryService.createProcessDefinitionQuery().suspended()
                .orderByProcessDefinitionName().asc().orderByProcessDefinitionVersion().asc().listPage(start, count);
