...
public class StartProcessInstanceClickListener implements ClickListener {
    ...
    public void buttonClick(ClickEvent event) {
        ...
        if (startFormData != null
            ...
            notificationManager
                    .showInformationNotification(Messages.PROCESS_STARTED_NOTIFICATION, getProcessDisplayName(processDefinition));

            // Switch to inbox page in case a task of this process was created
            List<Task> loggedInUsersTasks = taskService.createTaskQuery().taskAssignee(ExplorerApp.get().getLoggedInUser().getId())
