...
public class ProcessDiagramLayoutFactory {
    ...
    protected Map<String, DiagramElement> transformBoundsForImage(DiagramNode diagramBoundsImage, DiagramNode diagramBoundsXml,
        ...
        if (isExportedFromAdonis50(bpmnModel)) {
            ...
            for (Entry<String, DiagramNode> entry : elementBoundsFromBpmnDi.entrySet()) {
                ...
                try {
                    ...
                    throw new ActivitiException("Error while evaluating the following XPath expression on a BPMN XML document: '"
                            + expression + "'.", e);
                }
