...
public class HistoricIdentityLinkEntityManager extends AbstractManager {
    ...
    @SuppressWarnings("unchecked")
    public List<HistoricIdentityLinkEntity> findHistoricIdentityLinkByTaskUserGroupAndType(String taskId, String userId, String groupId,
            String type) {
    ...
    @SuppressWarnings("unchecked")
    public List<HistoricIdentityLinkEntity> findHistoricIdentityLinkByProcessDefinitionUserAndGroup(String processDefinitionId,
    ...
    public void deleteHistoricIdentityLinksByProcInstance(String processInstanceId) {
        ...
        List<HistoricIdentityLinkEntity> identityLinksFromCache = Context.getCommandContext().getDbSqlSession()
                .findInCache(HistoricIdentityLinkEntity.class);
