...
public class CommentEntityManager extends AbstractManager {
    ...
    public void delete(PersistentObject persistentObject) {
        ...
        if (getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
            ...
            getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(
                    ActivitiEventBuilder.createEntityEvent(ActivitiEventType.ENTITY_DELETED, persistentObject, processInstanceId,
    ...
    public void insert(PersistentObject persistentObject) {
        ...
        if (getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
            ...
            getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(
                    ActivitiEventBuilder.createEntityEvent(ActivitiEventType.ENTITY_CREATED, persistentObject, processInstanceId,
                            processInstanceId, processDefinitionId));
            getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(
                    ActivitiEventBuilder.createEntityEvent(ActivitiEventType.ENTITY_INITIALIZED, persistentObject, processInstanceId,
                            processInstanceId, processDefinitionId));
        }
    }
