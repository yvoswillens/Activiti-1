...
public class ExpressionFactoryImpl extends ExpressionFactory {
    ...
    @Override
    public final TreeMethodExpression createMethodExpression(ELContext context, String expression, Class<?> expectedReturnType,
            Class<?>[] expectedParamTypes) {
        return new TreeMethodExpression(store, context.getFunctionMapper(), context.getVariableMapper(), converter, expression,
