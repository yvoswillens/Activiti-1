...
public class ErrorEventDefinitionParseHandler extends AbstractBpmnParseHandler<ErrorEventDefinition> {
    ...
    protected void executeParse(BpmnParse bpmnParse, ErrorEventDefinition eventDefinition) {
        ...
        if (bpmnParse.getCurrentFlowElement() instanceof StartEvent) {
            ...
            activity.setActivityBehavior(bpmnParse.getActivityBehaviorFactory().createBoundaryEventActivityBehavior(boundaryEvent,
    ...
    protected void createErrorStartEventDefinition(ErrorEventDefinition errorEventDefinition, ActivityImpl startEventActivity,
            ScopeImpl scope) {
        org.activiti5.engine.impl.bpmn.parser.ErrorEventDefinition definition = new org.activiti5.engine.impl.bpmn.parser.ErrorEventDefinition(
    ...
    public void createBoundaryErrorEventDefinition(ErrorEventDefinition errorEventDefinition, boolean interrupting, ActivityImpl activity,
    ...
    protected void addErrorEventDefinition(org.activiti5.engine.impl.bpmn.parser.ErrorEventDefinition errorEventDefinition,
