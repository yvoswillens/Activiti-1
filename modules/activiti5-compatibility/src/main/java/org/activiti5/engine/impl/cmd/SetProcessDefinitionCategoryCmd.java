...
public class SetProcessDefinitionCategoryCmd implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        ProcessDefinitionEntity processDefinition = commandContext.getProcessDefinitionEntityManager().findProcessDefinitionById(
                processDefinitionId);
        ...
        DeploymentCache<ProcessDefinitionEntity> processDefinitionCache = commandContext.getProcessEngineConfiguration()
