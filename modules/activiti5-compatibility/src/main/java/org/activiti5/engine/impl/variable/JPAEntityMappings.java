    ...
    public String getIdString(Object value) {
        ...
        if (value instanceof java.util.Date) {
            ...
            return "" + ((java.sql.Date) value).getTime();
                ...
                || value instanceof Integer || value instanceof Float || value instanceof Double || value instanceof Character
                || value instanceof BigDecimal || value instanceof BigInteger || value instanceof UUID) {
