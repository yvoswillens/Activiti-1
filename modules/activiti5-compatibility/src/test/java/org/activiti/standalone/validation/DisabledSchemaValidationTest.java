...
public class DisabledSchemaValidationTest {
    ...
    @Before
    public void setup() {
        this.processEngine = new StandaloneInMemProcessEngineConfiguration().setJdbcUrl(
                "jdbc:h2:mem:activiti-process-validation;DB_CLOSE_DELAY=1000").buildProcessEngine();
    ...
    public void testDisableValidation() {
        ...
        try {
            repositoryService.createDeployment()
                    .addClasspathResource("org/activiti/standalone/validation/invalid_process_xsd_error.bpmn20.xml").deploy();
            Assert.fail();
