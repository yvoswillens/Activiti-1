...
public class PvmScopeAndEventsTest extends PvmTestCase {
    ...
    public void testStartEndWithScopesAndNestedActivities() {
        ...
        PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("scopes and events")
                ...
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("outerScope")
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                ...
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).transition("waitInFirst")
                .endActivity().createActivity("waitInFirst").behavior(new WaitState())
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).transition("waitInSecond")
                .endActivity().endActivity().endActivity().createActivity("secondInnerScope")
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                .createActivity("secondMostInnerNestedActivity")
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("waitInSecond")
                ...
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).endActivity().endActivity()
                .endActivity().endActivity().endActivity().buildProcessDefinition();
    ...
    public void testStartEndWithScopesAndNestedActivitiesNotAtInitial() {
        ...
        PvmProcessInstance processInstance = ((ProcessDefinitionImpl) processDefinition)
                .createProcessInstanceForInitial(alternativeInitial);
        processInstance.start();
