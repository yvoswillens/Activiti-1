...
public class DeployInvalidXmlTest extends PluggableActivitiTestCase {
        ...
        try {
            repositoryService
                    ...
                    .addClasspathResource(
                            "org/activiti/engine/test/api/repository/noWayPointsForSequenceFlowInDiagramInterchange.bpmn20.xml").deploy()
                    .getId();
            fail();
        } catch (XMLException e) {
            // expected exception
    ...
    private static String UNSAFE_XML = "<?xml version='1.0' encoding='UTF-8'?>"
            ...
            + "<!ENTITY lol9 '&lol8;&lol8;&lol8;&lol8;&lol8;&lol8;&lol8;&lol8;&lol8;&lol8;&lol8;'>" + "]>" + "<lolz>&lol9;</lolz>"
            ...
            + " <sequenceFlow id='flow2' sourceRef='theTask' targetRef='theEnd' />" + " <endEvent id='theEnd' />" + "</process>"
            + "</definitions>";
    ...
    public void testExternalEntityResolvingTest() {
        String deploymentId = repositoryService
                .createDeployment()
                .addClasspathResource(
                        "org/activiti/engine/test/api/repository/DeployInvalidXmlTest.testExternalEntityResolvingTest.bpmn20.xml").deploy()
                .getId();
        try {
