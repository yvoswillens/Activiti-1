...
public class InclusiveGatewayTest extends PluggableActivitiTestCase {
    ...
    public void testNoSequenceFlowSelected() {
        try {
            ...
            assertTextPresent(
                    "No outgoing sequence flow of the inclusive gateway 'inclusiveGw' could be selected for continuing the process",
                    e.getMessage());
        }
    }
    ...
    public void testDecideBasedOnListOrArrayOfBeans() {
        ...
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("inclusiveDecisionBasedOnListOrArrayOfBeans",
                CollectionUtil.singletonMap("orders", orders));
