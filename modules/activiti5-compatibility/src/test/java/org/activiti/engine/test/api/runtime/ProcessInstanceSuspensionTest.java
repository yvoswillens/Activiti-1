...
public class ProcessInstanceSuspensionTest extends PluggableActivitiTestCase {
    ...
    @Deployment(resources = { "org/activiti/engine/test/api/runtime/superProcessWithMultipleNestedSubProcess.bpmn20.xml",
    ...
    public void testQueryForActiveAndSuspendedProcessInstances() {
        ...
        ProcessInstance piToSuspend = runtimeService.createProcessInstanceQuery().processDefinitionKey("nestedSubProcessQueryTest")
                .singleResult();
    ...
    public void testSubmitTaskFormAfterProcessInstanceSuspend() {
        ...
        try {
            formService.submitTaskFormData(taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult().getId(),
