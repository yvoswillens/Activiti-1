...
public class DeleteProcessInstanceTest extends PluggableActivitiTestCase {
    ...
    public void testNoEndTimeSet() {
        ...
        Execution executionUser = runtimeService.createExecutionQuery().processInstanceId(instanceUser.getProcessInstanceId())
                .singleResult();
        ...
        // Assert that the process instance is active.
        Execution executionJava = runtimeService.createExecutionQuery().processInstanceId(instanceJava.getProcessInstanceId())
                .singleResult();
