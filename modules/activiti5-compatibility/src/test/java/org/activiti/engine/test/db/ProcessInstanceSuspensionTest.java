...
public class ProcessInstanceSuspensionTest extends PluggableActivitiTestCase {
    ...
    public void testSuspendedProcessTimerExecution() throws Exception {
        ...
        List<TimerEntity> jobs = commandExecutor.execute(new GetUnlockedTimersByDuedateCmd(processEngineConfiguration.getClock()
        ...
        jobs = commandExecutor.execute(new GetUnlockedTimersByDuedateCmd(processEngineConfiguration.getClock().getCurrentTime(), new Page(
                0, 1)));
