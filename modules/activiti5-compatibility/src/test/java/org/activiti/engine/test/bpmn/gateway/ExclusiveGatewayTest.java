...
public class ExclusiveGatewayTest extends PluggableActivitiTestCase {
    ...
    public void testDecideBasedOnListOrArrayOfBeans() {
        ...
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("decisionBasedOnListOrArrayOfBeans",
    ...
    public void testDefaultSequenceFlow() {
        ...
        String procId = runtimeService.startProcessInstanceByKey("exclusiveGwDefaultSequenceFlow", CollectionUtil.singletonMap("input", 1))
                .getId();
        Task task = taskService.createTaskQuery().singleResult();
    ...
    public void testInvalidProcessDefinition() {
        String defaultFlowWithCondition = "<?xml version='1.0' encoding='UTF-8'?>"
                ...
                "    <userTask id='theTask1' name='Input is one' /> " + "    <userTask id='theTask2' name='Default input' /> "
                + "  </process>" + "</definitions>";
