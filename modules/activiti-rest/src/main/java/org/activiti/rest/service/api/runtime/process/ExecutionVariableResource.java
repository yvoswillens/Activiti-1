...
public class ExecutionVariableResource extends BaseExecutionVariableResource {
    ...
    public RestVariable getVariable(@PathVariable("executionId") String executionId, @PathVariable("variableName") String variableName,
    ...
    public RestVariable updateVariable(@PathVariable("executionId") String executionId, @PathVariable("variableName") String variableName,
    ...
    public void deleteVariable(@PathVariable("executionId") String executionId, @PathVariable("variableName") String variableName,
        ...
        if (!hasVariableOnScope(execution, variableName, variableScope)) {
            throw new ActivitiObjectNotFoundException("Execution '" + execution.getId() + "' doesn't have a variable '" + variableName
                    + "' in scope " + variableScope.name().toLowerCase(), VariableInstanceEntity.class);
        }
