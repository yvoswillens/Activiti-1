...
public class HistoricTaskInstanceBaseResource {
    ...
    protected DataResponse getQueryResponse(HistoricTaskInstanceQueryRequest queryRequest, Map<String, String> allRequestParams,
        ...
        return new HistoricTaskInstancePaginateList(restResponseFactory, serverRootUrl).paginateList(allRequestParams, queryRequest, query,
                "taskInstanceId", allowedSortProperties);
    }
        ...
        for (QueryVariable variable : variables) {
            ...
            case LIKE:
                if (actualValue instanceof String) {
                    ...
                    throw new ActivitiIllegalArgumentException("Only string variable values are supported using like, but was: "
                            + actualValue.getClass().getName());
                }
                break;
            default:
