...
public class TaskVariableResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetTaskVariable() throws Exception {
        try {
            ...
            response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX
                            + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE, processTask.getId(), "sharedVariable")),
                    HttpStatus.SC_OK);
            ...
            closeResponse(executeRequest(
                    new HttpGet(SERVER_URL_PREFIX
                            + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE, processTask.getId(), "unexistingVariable")),
                    HttpStatus.SC_NOT_FOUND));
    ...
    public void testGetTaskVariableData() throws Exception {
        try {
            ...
            CloseableHttpResponse response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX
                            + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE_DATA, task.getId(), "localTaskVariable")),
                    HttpStatus.SC_OK);
    ...
    public void testGetTaskVariableDataForIllegalVariables() throws Exception {
        try {
            ...
            closeResponse(executeRequest(
                    new HttpGet(SERVER_URL_PREFIX
                            + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE_DATA, task.getId(), "unexistingVariable")),
                    HttpStatus.SC_NOT_FOUND));
    ...
    public void testUpdateBinaryTaskVariable() throws Exception {
        try {
            ...
            assertTrue(responseNode.get("valueUrl").asText()
                    .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE_DATA, task.getId(), "binaryVariable")));
