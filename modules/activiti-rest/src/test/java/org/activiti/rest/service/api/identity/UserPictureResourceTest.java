...
public class UserPictureResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetUserPicture() throws Exception {
        ...
        try {
            ...
            CloseableHttpResponse response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_PICTURE, newUser.getId())),
                    HttpStatus.SC_OK);
    ...
    public void testGetPictureForUnexistingUser() throws Exception {
        closeResponse(executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_PICTURE, "unexisting")),
    ...
    public void testUpdatePicture() throws Exception {
        ...
        try {
            ...
            httpPut.setEntity(HttpMultipartHelper.getMultiPartEntity("myPicture.png", "image/png", new ByteArrayInputStream(
                    "this is the picture raw byte stream".getBytes()), null));
    ...
    public void testUpdatePictureWithCustomMimeType() throws Exception {
        ...
        try {
            ...
            HttpPut httpPut = new HttpPut(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_PICTURE, newUser.getId()));
            httpPut.setEntity(HttpMultipartHelper.getMultiPartEntity("myPicture.png", "image/png", new ByteArrayInputStream(
                    "this is the picture raw byte stream".getBytes()), additionalFields));
            closeResponse(executeBinaryRequest(httpPut, HttpStatus.SC_NO_CONTENT));
