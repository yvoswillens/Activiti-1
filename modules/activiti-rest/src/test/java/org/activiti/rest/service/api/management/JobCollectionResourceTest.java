...
public class JobCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetJobs() throws Exception {
        ...
        url = RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?processDefinitionId="
        ...
        closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION)
                + "?timersOnly=true&messagesOnly=true"), HttpStatus.SC_BAD_REQUEST));
