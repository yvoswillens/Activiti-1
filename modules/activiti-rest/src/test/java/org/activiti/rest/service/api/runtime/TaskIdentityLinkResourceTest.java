            ...
            if (!link.get("user").isNull()) {
                if (link.get("user").textValue().equals("john")) {
                    ...
                    assertTrue(link
                            ...
                            .textValue()
                            .endsWith(
                                    RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_IDENTITYLINK, task.getId(), "users", "john",
                                            "customType")));
                    ...
                    assertTrue(link
                            ...
                            .textValue()
                            .endsWith(
                                    RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_IDENTITYLINK, task.getId(), "users", "kermit",
                                            "candidate")));
                ...
                assertTrue(link
                        ...
                        .textValue()
                        .endsWith(
                                RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_IDENTITYLINK, task.getId(),
    ...
    public void testGetSingleIdentityLink() throws Exception {
        try {
            ...
            httpGet = new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_IDENTITYLINK, "unexistingtask",
                            RestUrls.SEGMENT_IDENTITYLINKS_FAMILY_USERS, "kermit", "myType"));
    ...
    public void testDeleteSingleIdentityLink() throws Exception {
        try {
            ...
            httpDelete = new HttpDelete(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_IDENTITYLINK, task.getId(),
                            RestUrls.SEGMENT_IDENTITYLINKS_FAMILY_USERS, "kermit", "unexistingtype"));
