...
public class UserResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetUser() throws Exception {
        ...
        try {
            ...
            CloseableHttpResponse response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER, newUser.getId())),
                    HttpStatus.SC_OK);
    ...
    public void testGetUnexistingUser() throws Exception {
        closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER, "unexisting")),
    ...
    public void testDeleteUser() throws Exception {
        ...
        try {
            ...
            closeResponse(executeRequest(
                    new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER, newUser.getId())),
    ...
    public void testDeleteUnexistingUser() throws Exception {
        closeResponse(executeRequest(
                new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER, "unexisting")),
                HttpStatus.SC_NOT_FOUND));
    }
