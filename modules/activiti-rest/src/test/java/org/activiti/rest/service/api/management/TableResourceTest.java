...
public class TableResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetTables() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TABLES_COLLECTION)), HttpStatus.SC_OK);
        ...
        for (int i = 0; i < responseNode.size(); i++) {
            ...
            assertTrue(table.get("url").textValue()
    ...
    public void testGetTable() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TABLE, tableNameToGet)), HttpStatus.SC_OK);
    ...
    public void testGetUnexistingTable() throws Exception {
        closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TABLE, "unexisting")),
