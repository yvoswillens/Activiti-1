...
public class UserInfoResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetUserInfoCollection() throws Exception {
        ...
        try {
            ...
            CloseableHttpResponse response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_INFO_COLLECTION, newUser.getId())),
                    HttpStatus.SC_OK);
            ...
            for (int i = 0; i < responseNode.size(); i++) {
                ...
                if (info.get("key").textValue().equals("key1")) {
                    foundFirst = true;
                    assertTrue(info.get("url").textValue()
    ...
    public void testGetUserInfo() throws Exception {
        ...
        try {
            ...
            CloseableHttpResponse response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_INFO, newUser.getId(), "key1")),
                    HttpStatus.SC_OK);
            JsonNode responseNode = objectMapper.readTree(response.getEntity().getContent());
            closeResponse(response);
    ...
    public void testGetInfoForUnexistingUser() throws Exception {
        closeResponse(executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_INFO, "unexisting", "key1")),
    ...
    public void testGetInfoForUserWithoutInfo() throws Exception {
        ...
        try {
            ...
            closeResponse(executeRequest(
                    new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_INFO, "testuser", "key1")),
                    HttpStatus.SC_NOT_FOUND));
    ...
    public void testDeleteUserInfo() throws Exception {
        ...
        try {
            ...
            closeResponse(executeRequest(
                    new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_INFO, newUser.getId(), "key1")),
    ...
    public void testDeleteInfoForUnexistingUser() throws Exception {
        closeResponse(executeRequest(
                new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_INFO, "unexisting", "key1")),
                HttpStatus.SC_NOT_FOUND));
    }
    ...
    public void testDeleteInfoForUserWithoutInfo() throws Exception {
        ...
        try {
            ...
            closeResponse(executeRequest(
                    new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_INFO, "testuser", "key1")),
                    HttpStatus.SC_NOT_FOUND));
