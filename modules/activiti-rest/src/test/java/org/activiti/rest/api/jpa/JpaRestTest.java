...
public class JpaRestTest extends BaseJPARestTestCase {
    ...
    public void testGetJpaVariableViaTaskVariablesCollections() throws Exception {
        ...
        HttpResponse response = executeHttpRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLES_COLLECTION, task.getId())),
                HttpStatus.SC_OK);
    ...
    public void testGetJpaVariableViaTaskCollection() throws Exception {
        ...
        // local
        HttpResponse response = executeHttpRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_COLLECTION)
                        + "?includeProcessVariables=true"), HttpStatus.SC_OK);
    ...
    public void testGetJpaVariableViaHistoricProcessCollection() throws Exception {
        ...
        // local
        HttpResponse response = executeHttpRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_PROCESS_INSTANCES)
    ...
    public void testGetJpaVariableViaHistoricVariablesCollections() throws Exception {
        ...
        // local
        HttpResponse response = executeHttpRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_VARIABLE_INSTANCES)
