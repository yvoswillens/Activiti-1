...
public class ExecutionResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetExecution() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION, parentExecution.getId())),
                HttpStatus.SC_OK);
        ...
        assertTrue(responseNode.get("url").asText()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION, parentExecution.getId())));

        assertTrue(responseNode.get("processInstanceUrl").asText()
        ...
        response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION, childExecution.getId())),
                HttpStatus.SC_OK);
        ...
        assertTrue(responseNode.get("parentUrl").asText()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION, parentExecution.getId())));
    ...
    public void testGetUnexistingExecution() throws Exception {
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION, "unexisting")),
    ...
    public void testSignalExecution() throws Exception {
        ...
        assertEquals("anotherWaitState", runtimeService.createExecutionQuery().executionId(signalExecution.getId()).singleResult()
                .getActivityId());
