...
public class ExecutionVariableResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetExecutionVariable() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX
                        + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE, childExecution.getId(), "variable")),
                HttpStatus.SC_OK);
        ...
        response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX
                        ...
                        + "?scope=illegal"), HttpStatus.SC_BAD_REQUEST);
        closeResponse(response);
        ...
        response = executeRequest(
                new HttpGet(
                        SERVER_URL_PREFIX
                                + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE, processInstance.getId(),
                                        "unexistingVariable")), HttpStatus.SC_NOT_FOUND);
        closeResponse(response);
    }
    ...
    public void testGetExecutionVariableData() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX
                        + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE_DATA, childExecution.getId(), "var")),
                HttpStatus.SC_OK);
    ...
    public void testGetExecutionVariableDataSerializable() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX
                        + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE_DATA, processInstance.getId(), "var")),
                HttpStatus.SC_OK);
        closeResponse(response);
    ...
    public void testGetExecutionDataForIllegalVariables() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX
                        + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE_DATA, processInstance.getId(),
                                "localTaskVariable")), HttpStatus.SC_NOT_FOUND);
        closeResponse(response);
    ...
    public void testDeleteExecutionVariable() throws Exception {
        ...
        HttpDelete httpDelete = new HttpDelete(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE, childExecution.getId(), "myVariable"));
    ...
    public void testUpdateExecutionVariable() throws Exception {
        ...
        httpPut = new HttpPut(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE, childExecution.getId(), "unexistingVariable"));
        httpPut.setEntity(new StringEntity(requestNode.toString()));
    ...
    public void testUpdateBinaryExecutionVariable() throws Exception {
        ...
        HttpPut httpPut = new HttpPut(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE, childExecution.getId(), "binaryVariable"));
        ...
        assertTrue(responseNode
                ...
                .asText()
                .endsWith(
                        RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION_VARIABLE_DATA, childExecution.getId(), "binaryVariable")));
