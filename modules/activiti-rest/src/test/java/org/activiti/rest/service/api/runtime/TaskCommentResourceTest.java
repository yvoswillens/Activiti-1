...
public class TaskCommentResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetComments() throws Exception {
        try {
            ...
            assertTrue(commentNode.get("taskUrl").textValue()
    ...
    public void testCreateComment() throws Exception {
        try {
            ...
            assertTrue(responseNode.get("taskUrl").textValue()
                    .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_COMMENT, task.getId(), commentsOnTask.get(0).getId())));
    ...
    public void testCreateCommentWithProcessInstanceId() throws Exception {
        ...
        assertTrue(responseNode
                ...
                .textValue()
                .endsWith(
                        RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_PROCESS_INSTANCE_COMMENT, processInstance.getId(),
