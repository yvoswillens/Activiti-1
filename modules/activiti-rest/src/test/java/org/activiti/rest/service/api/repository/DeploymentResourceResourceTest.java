    ...
    public void testGetDeploymentResource() throws Exception {
        try {
            ...
            assertTrue(responseNode.get("url").textValue()
                    .equals(buildUrl(RestUrls.URL_DEPLOYMENT_RESOURCE, deployment.getId(), rawResourceName)));
            assertTrue(responseNode.get("contentUrl").textValue()
                    .equals(buildUrl(RestUrls.URL_DEPLOYMENT_RESOURCE_CONTENT, deployment.getId(), rawResourceName)));
