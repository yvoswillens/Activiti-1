...
public class HistoricDetailCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    public void testQueryDetail() throws Exception {
        ...
        assertResultsPresentInDataResponse(url + "?processInstanceId=" + processInstance2.getId() + "&selectOnlyVariableUpdates=true", 4,
                "booleanVar", false);

        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX + url + "?processInstanceId=" + processInstance2.getId()), HttpStatus.SC_OK);
