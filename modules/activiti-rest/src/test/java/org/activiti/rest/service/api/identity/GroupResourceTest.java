...
public class GroupResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetUnexistingGroup() throws Exception {
        closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP, "unexisting")),
    ...
    public void testDeleteGroup() throws Exception {
        try {
            ...
            closeResponse(executeRequest(
                    new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP, "testgroup")),
    ...
    public void testDeleteUnexistingGroup() throws Exception {
        closeResponse(executeRequest(
                new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP, "unexisting")),
                HttpStatus.SC_NOT_FOUND));
    }
