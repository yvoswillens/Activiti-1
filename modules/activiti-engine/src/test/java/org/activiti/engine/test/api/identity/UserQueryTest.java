...
public class UserQueryTest extends PluggableActivitiTestCase {
    ...
    public void testNativeQuery() {
        ...
        assertEquals(1, identityService.createNativeUserQuery().sql(baseQuerySql + " where ID_ = #{id}").parameter("id", "kermit").list()
                .size());
        ...
        assertEquals(1, identityService.createNativeUserQuery().sql(baseQuerySql + " where ID_ = #{id}").parameter("id", "kermit")
                .listPage(0, 1).size());
    }
