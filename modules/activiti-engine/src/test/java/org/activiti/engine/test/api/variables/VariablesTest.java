...
public class VariablesTest extends PluggableActivitiTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        repositoryService.createDeployment().addClasspathResource("org/activiti/engine/test/api/variables/VariablesTest.bpmn20.xml")
                .deploy();
    ...
    public void testGetVariablesWithCollectionThroughRuntimeService() {
        ...
        Map<String, Object> vars = runtimeService
                .getVariables(processInstanceId, Arrays.asList("intVar1", "intVar3", "intVar5", "intVar9"));
        ...
        assertEquals(4, runtimeService.getVariablesLocal(processInstanceId, Arrays.asList("intVar1", "intVar3", "intVar5", "intVar9"))
                .size());
