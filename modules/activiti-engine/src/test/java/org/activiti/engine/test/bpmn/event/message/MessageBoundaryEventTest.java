...
public class MessageBoundaryEventTest extends PluggableActivitiTestCase {
    ...
    public void testBoundaryMessageEventOnSubprocess() {
        ...
        Execution executionMessageOne = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_one")
                .singleResult();
        ...
        Execution executionMessageTwo = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_two")
                .singleResult();
