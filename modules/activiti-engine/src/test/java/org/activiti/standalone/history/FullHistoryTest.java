...
public class FullHistoryTest extends ResourceActivitiTestCase {
    ...
    public void testVariableUpdates() {
        ...
        List<HistoricDetail> historicDetails = historyService.createHistoricDetailQuery().orderByVariableName().asc()
    ...
    public void testHistoricVariableInstanceQueryTaskVariables() {
        ...
        assertEquals("setFromTask", historyService.createHistoricVariableInstanceQuery().taskId(activeTask.getId()).singleResult()
                .getValue());
        assertEquals(activeTask.getId(), historyService.createHistoricVariableInstanceQuery().taskId(activeTask.getId()).singleResult()
                .getTaskId());
    ...
    public void testHistoricVariableInstanceQuery() {
        ...
        HistoricVariableInstance historicProcessVariable = historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("process", "one").singleResult();
    ...
    public void testHistoricVariableUpdatesAllTypes() throws Exception {
        ...
        List<HistoricDetail> details = historyService.createHistoricDetailQuery().variableUpdates()
                .processInstanceId(processInstance.getId()).orderByVariableName().asc().orderByTime().asc().list();
    ...
    public void testHistoricFormProperties() throws Exception {
        ...
        ProcessDefinition procDef = repositoryService.createProcessDefinitionQuery().processDefinitionKey("historicFormPropertiesProcess")
                .singleResult();
        ...
        historicActivityInstance = historyService.createHistoricActivityInstanceQuery()
                .activityInstanceId(historicProperty2.getActivityInstanceId()).singleResult();
        assertNotNull(historicActivityInstance);
        assertEquals("start", historicActivityInstance.getActivityId());
        ...
        historicActivityInstance = historyService.createHistoricActivityInstanceQuery().activityInstanceId(activityInstanceId)
                .singleResult();
        assertNotNull(historicActivityInstance);
    ...
    public void testHistoricDetailQueryMixed() throws Exception {
        ...
        ProcessDefinition procDef = repositoryService.createProcessDefinitionQuery().processDefinitionKey("historicDetailMixed")
                .singleResult();
        ProcessInstance processInstance = formService.submitStartFormData(procDef.getId(), formProperties);

        List<HistoricDetail> details = historyService.createHistoricDetailQuery().processInstanceId(processInstance.getId())
    ...
    public void testHistoricTaskInstanceVariableUpdates() {
        ...
        List<HistoricDetail> historicTaskVariableUpdates = historyService.createHistoricDetailQuery().taskId(taskId).variableUpdates()
                .orderByVariableName().asc().list();
        ...
        historicTaskVariableUpdates = historyService.createHistoricDetailQuery().taskId(taskId).variableUpdates().orderByVariableName()
                .asc().list();
    ...
    public void testHistoricFormPropertiesOnReEnteringActivity() {
        ...
        List<HistoricDetail> details = historyService.createHistoricDetailQuery().formProperties()
    ...
    public void testHistoricTaskInstanceQueryProcessVariableValueEquals() throws Exception {
        ...
        assertEquals(1, historyService.createHistoricTaskInstanceQuery().processVariableValueEquals("stringVar", "updatedStringValue")
                .count());
    ...
    public void testHistoricProcessInstanceVariableValueNotEquals() throws Exception {
        ...
        assertEquals(1, historyService.createHistoricProcessInstanceQuery().variableValueNotEquals("stringVar", "updatedStringValue")
                .count());
        ...
        assertEquals(0, historyService.createHistoricProcessInstanceQuery().variableValueNotEquals("stringVar", "updatedStringValue")
                .count());
    ...
    public void testReadJpaVariableValueFromHistoricVariableUpdate() {
        ...
        List<HistoricDetail> variableUpdates = historyService.createHistoricDetailQuery().processInstanceId(executionId).variableUpdates()
                .list();
    ...
    public void testQueryHistoricTaskIncludeBinaryVariable() throws Exception {
        ...
        HistoricTaskInstance historicTask = historyService.createHistoricTaskInstanceQuery().taskId(task.getId()).includeProcessVariables()
                .singleResult();
