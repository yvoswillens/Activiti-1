...
public class CommentEntityManager extends AbstractEntityManager<CommentEntity> {
    ...
    public void delete(CommentEntity commentEntity) {
        ...
        if (getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
            ...
            getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(
                    ActivitiEventBuilder.createEntityEvent(ActivitiEventType.ENTITY_DELETED, commentEntity, processInstanceId,
    ...
    public void insert(CommentEntity commentEntity) {
        ...
        if (getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
            ...
            getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(
                    ActivitiEventBuilder.createEntityEvent(ActivitiEventType.ENTITY_CREATED, commentEntity, processInstanceId,
                            processInstanceId, processDefinitionId));
            getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(
                    ActivitiEventBuilder.createEntityEvent(ActivitiEventType.ENTITY_INITIALIZED, commentEntity, processInstanceId,
                            processInstanceId, processDefinitionId));
        }
    }
