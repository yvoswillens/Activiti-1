...
public class ContinueProcessOperation extends AbstractOperation {
    ...
    public void run() {
        ...
        if (currentFlowElement instanceof FlowNode) {
            ...
            throw new RuntimeException("Programmatic error: no current flow element found or invalid type: " + currentFlowElement
                    + ". Halting.");
        }
    ...
    private void continueThroughFlowNode(FlowNode flowNode) {
        ...
        logger.debug("Executing activityBehavior {} on activity '{}' with execution {}", activityBehavior.getClass(), flowNode.getId(),
                execution.getId());
    ...
    protected void executeBoundaryEvents(Collection<BoundaryEvent> boundaryEvents) {
        ...
        for (BoundaryEvent boundaryEvent : boundaryEvents) {
            ...
            if (boundaryEventBehavior != null) {
                logger.debug("Executing boundary event activityBehavior {} with execution {}", boundaryEventBehavior.getClass(),
