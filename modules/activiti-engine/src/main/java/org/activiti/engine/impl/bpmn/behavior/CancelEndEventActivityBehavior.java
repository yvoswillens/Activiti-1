...
public class CancelEndEventActivityBehavior extends FlowNodeActivityBehavior {
    ...
    public void execute(ActivityExecution execution) {
        ...
        ActivityImpl cancelBoundaryEvent = ScopeUtil.findInParentScopesByBehaviorType((ActivityImpl) execution.getActivity(),
        ...
        ActivityExecution scopeExecution = ScopeUtil.findScopeExecutionForScope((ExecutionEntity) execution,
                cancelBoundaryEvent.getParentActivity());
