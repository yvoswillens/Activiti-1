...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
    ...
    protected void initDataSource() {
        if (dataSource == null) {
            if (dataSourceJndiName != null) {
                ...
                PooledDataSource pooledDataSource = new PooledDataSource(ReflectUtil.getClassLoader(), jdbcDriver, jdbcUrl, jdbcUsername,
                        jdbcPassword);
    ...
    protected void initConfigurators() {
        ...
        if (enableConfiguratorServiceLoader) {
            ...
            if (nrOfServiceLoadedConfigurators > 0) {
                log.info("Found {} auto-discoverable Process Engine Configurator{}", nrOfServiceLoadedConfigurators++,
            ...
            for (int i = 0; i < bpmnParserHandlers.size(); i++) {
                ...
                if (defaultBpmnParseHandler.getHandledTypes().size() != 1) {
                    ...
                    if (customParseHandlerMap.containsKey(handledType)) {
                        ...
                        log.info("Replacing default BpmnParseHandler " + defaultBpmnParseHandler.getClass().getName() + " with "
    ...
    protected void initJpa() {
        ...
        if (jpaEntityManagerFactory != null) {
            sessionFactories.put(EntityManagerSession.class, new EntityManagerSessionFactory(jpaEntityManagerFactory, jpaHandleTransaction,
