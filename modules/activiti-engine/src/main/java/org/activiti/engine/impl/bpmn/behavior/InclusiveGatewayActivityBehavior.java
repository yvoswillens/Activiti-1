...
public class InclusiveGatewayActivityBehavior extends GatewayActivityBehavior implements InactiveActivityBehavior {
    ...
    protected void executeInclusiveGatewayLogic(ExecutionEntity execution) {
        ...
        Collection<ExecutionEntity> allExecutions = executionEntityManager.findChildExecutionsByProcessInstanceId(execution
        ...
        if (!oneExecutionCanReachGateway) {
            ...
            Collection<ExecutionEntity> executionsInGateway = executionEntityManager.getInactiveExecutionsInActivity(execution
