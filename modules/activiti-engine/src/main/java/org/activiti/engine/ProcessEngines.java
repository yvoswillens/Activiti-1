...
public abstract class ProcessEngines {
    ...
    public synchronized static void init() {
        if (!isInitialized()) {
            ...
            try {
                ...
                throw new ActivitiIllegalArgumentException("problem retrieving activiti.cfg.xml resources on the classpath: "
            ...
            try {
                ...
                throw new ActivitiIllegalArgumentException("problem retrieving activiti-context.xml resources on the classpath: "
                        + System.getProperty("java.class.path"), e);
            }
            while (resources.hasMoreElements()) {
    ...
    protected static void initProcessEngineFromSpringResource(URL resource) {
        try {
            ...
            throw new ActivitiException("couldn't initialize process engine from spring configuration resource " + resource.toString()
                    + ": " + e.getMessage(), e);
        }
    }
        ...
        if (isInitialized()) {
            ...
            for (String processEngineName : engines.keySet()) {
                ...
                try {
                    ...
                    log.error("exception while closing {}", (processEngineName == null ? "the default process engine" : "process engine "
                            + processEngineName), e);
                }
            }
