...
public abstract class AbstractDatabaseEventLoggerEventHandler implements EventLoggerEventHandler {
    ...
    protected EventLogEntryEntity createEventLogEntry(String processDefinitionId, String processInstanceId, String executionId,
    ...
    protected EventLogEntryEntity createEventLogEntry(String type, String processDefinitionId, String processInstanceId,
        ...
        if (!data.containsKey(Fields.TENANT_ID) && processDefinitionId != null) {
            DeploymentCache<ProcessDefinitionCacheEntry> processDefinitionCache = Context.getProcessEngineConfiguration()
                    .getProcessDefinitionCache();
            if (processDefinitionCache != null) {
                ProcessDefinitionEntity processDefinitionEntity = ProcessDefinitionCacheUtil
                        .getCachedProcessDefinitionEntity(processDefinitionId);
