...
public class UserTaskParseHandler extends AbstractActivityBpmnParseHandler<UserTask> {
    ...
    protected void executeParse(BpmnParse bpmnParse, UserTask userTask) {
        TaskDefinition taskDefinition = parseTaskDefinition(bpmnParse, userTask, userTask.getId(), (ProcessDefinitionEntity) bpmnParse
    ...
    public TaskDefinition parseTaskDefinition(BpmnParse bpmnParse, UserTask userTask, String taskDefinitionKey,
        ...
        taskFormHandler.parseConfiguration(userTask.getFormProperties(), userTask.getFormKey(), bpmnParse.getDeployment(),
                processDefinition);
