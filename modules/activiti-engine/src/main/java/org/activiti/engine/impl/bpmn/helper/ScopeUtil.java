...
public class ScopeUtil {
     ...
     */
    public static void throwCompensationEvent(List<CompensateEventSubscriptionEntity> eventSubscriptions, ActivityExecution execution,
            boolean async) {
        ...
        for (EventSubscriptionEntity eventSubscription : eventSubscriptions) {
            ...
            if (eventSubscription.getConfiguration() != null) {
                compensatingExecution = Context.getCommandContext().getExecutionEntityManager()
