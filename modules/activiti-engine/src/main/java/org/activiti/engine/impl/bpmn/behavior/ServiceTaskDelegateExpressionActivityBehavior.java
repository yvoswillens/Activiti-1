...
public class ServiceTaskDelegateExpressionActivityBehavior extends TaskActivityBehavior {
    ...
    public ServiceTaskDelegateExpressionActivityBehavior(Expression expression, Expression skipExpression,
            ...
            if (!isSkipExpressionEnabled
                ...
                if (delegate instanceof ActivityBehavior) {
                    ...
                    throw new ActivitiIllegalArgumentException("Delegate expression " + expression
                            + " did neither resolve to an implementation of " + ActivityBehavior.class + " nor " + JavaDelegate.class);
                }
            } else {
                leave(execution);
            }
