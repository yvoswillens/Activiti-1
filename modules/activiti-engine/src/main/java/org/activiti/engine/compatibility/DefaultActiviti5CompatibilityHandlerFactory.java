...
public class DefaultActiviti5CompatibilityHandlerFactory implements Activiti5CompatibilityHandlerFactory {
    ...
    public Activiti5CompatibilityHandler createActiviti5CompatibilityHandler() {
        ...
        try {
            Activiti5CompatibilityHandler handler = (Activiti5CompatibilityHandler) Class.forName(compatibilityHandlerClassName)
                    .newInstance();
            return handler;
        } catch (Exception e) {
            logger.debug("Activiti 5 compatibility handler implementation not found or error during instantiation. " + "Error : "
