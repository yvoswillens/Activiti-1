    ...
    public void run() {
        ...
        if (currentFlowElement instanceof FlowNode) {
            ...
            if (activityBehavior instanceof TriggerableActivityBehavior) {
                ...
                throw new RuntimeException("Invalid behavior: " + activityBehavior + " should implement "
                        + TriggerableActivityBehavior.class.getCanonicalName());
            }

        } else {
            throw new ActivitiException("Programmatic error: no current flow element found or invalid type: " + currentFlowElement
                    + ". Halting.");
        }
    }
