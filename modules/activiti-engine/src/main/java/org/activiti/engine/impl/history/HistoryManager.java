...
public interface HistoryManager extends Session {
     ...
     * Record a variable has been created, if audit history is enabled.
     */
    public abstract void recordHistoricDetailVariableCreate(VariableInstanceEntity variable, ExecutionEntity sourceActivityExecution,
     ...
     * created or deleted, if history is enabled.
     */
    public abstract void createProcessInstanceIdentityLinkComment(String processInstanceId, String userId, String groupId, String type,
            boolean create);
