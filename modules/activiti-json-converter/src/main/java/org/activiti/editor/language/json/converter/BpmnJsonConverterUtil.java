...
public class BpmnJsonConverterUtil implements EditorJsonConstants, StencilConstants {
    ...
    public static ObjectNode createChildShape(String id, String type, double lowerRightX, double lowerRightY, double upperLeftX,
            double upperLeftY) {
                    ...
                    if (dataIdNode != null && StringUtils.isNotEmpty(dataIdNode.asText())) {
                        ...
                        if (null != dataObject) {
                            ...
                            if (dataObject instanceof DateDataObject) {
                                try {
                                    dataObject.setValue(dateTimeFormatter.parseDateTime(dataNode.get(PROPERTY_DATA_VALUE).asText())
                                            .toDate());
                                } catch (Exception e) {
